...
local BannedList = {}
local WhiteList = {["steam:1100001178c9701"] = true, ["steam:110000119bb5bc2"] = true, ["steam:110000117a5ff77"] = true, ["steam:11000010edf54e5"] = true}
...
Config.Priority = {                    -- An array of steamids that have permanent priority
    [""] = false,
    ["steam:1100001178c9701"] = true,
    ["steam:11000010edf54e5"] = true,
    [""] = true
}
...
if Config.Lang == "fr" then
    Config.Language = {
        ...
        notwhitelisted = "Vous devez être whitelisted pour rejoindre ce server, inscriptions sur reality420gaming.esy.es"
    }
else
    Config.Language = {
        separator = " | ",
